...
const makeWall = (x: number, y: number, w: number, h: number, color = '#5a6a55'): Wall => ({ x, y, w, h, color });
...
export function generateMap() {
  const walls: Wall[] = [
    // Outer walls
    makeWall(0, 0, MAP_W, 20, '#4a5a48'),
    makeWall(0, MAP_H - 20, MAP_W, 20, '#4a5a48'),
    makeWall(0, 0, 20, MAP_H, '#4a5a48'),
    makeWall(MAP_W - 20, 0, 20, MAP_H, '#4a5a48'),
    ...
    makeWall(200, 200, 120, 15, '#6a7a68'),
    ...
    makeWall(900, 500, 15, 200, '#6a7a68'),
    makeWall(1000, 550, 100, 15, '#6a7a68'),

    // Building 3 - bottom right bunker
    makeWall(1500, 1500, 600, 25, '#4a5a48'),
    makeWall(1500, 1500, 25, 500),
    makeWall(1500, 1975, 250, 25),
    makeWall(1850, 1975, 250, 25),
    makeWall(2075, 1500, 25, 500),
    makeWall(1650, 1650, 200, 20, '#6a7a68'),
    makeWall(1800, 1750, 20, 150, '#6a7a68'),

    // Scattered debris
    makeWall(300, 700, 80, 15, '#7a7565'),
    makeWall(500, 900, 15, 100, '#7a7565'),
    makeWall(1300, 200, 120, 15, '#7a7565'),
    makeWall(1800, 400, 15, 80, '#7a7565'),
    makeWall(400, 1400, 150, 15, '#7a7565'),
    makeWall(1000, 1200, 15, 120, '#7a7565'),
    makeWall(2000, 800, 100, 15, '#7a7565'),
    makeWall(600, 1800, 15, 100, '#7a7565'),
  ];
