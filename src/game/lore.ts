...
P.S. Mice ate three MREs. Or not mice. God knows what runs around here at night.`,
  ...
  {
    id: 'doc_7',
    title: 'Personnel File: Commandant V. Volkov',
    author: 'GRU Internal Security',
    date: '08.02.1993',
    classification: 'TOP SECRET',
    content: `PERSONNEL FILE — TOP SECRET
Subject: Viktor Andreyevich Volkov
Rank: Commandant
Unit: Special Group "Wolf"
Station: Object Z-14, Underground Section

BACKGROUND:
Volkov was recruited from Spetsnaz in 1987. Outstanding combat record — 47 confirmed operations. Psychological profile shows extreme loyalty to the project but rising instability since the exposure.

EXPOSURE:
During inspection of Laboratory No. 3 (see "Dawn" protocol), Volkov was exposed to an unknown substance from B-series containers. Since then, subordinates report:
...
ASSESSMENT:
Despite instability, Volkov is the most effective commander at Z-14. He has refused evacuation, stating he "guards what lies beneath". Personnel report he patrols the deep storage at night, armed and muttering.

RECOMMENDATION: Monitor. Do NOT neutralize without direct orders. His knowledge of the B-series is irreplaceable.

WARNING: If Volkov shows signs of total regression — activate protocol STORM-3 immediately.
