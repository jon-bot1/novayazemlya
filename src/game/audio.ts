...
export function playGunshot(type: 'pistol' | 'rifle' | 'shotgun' | 'heavy' | 'turret' | 'boss' = 'pistol') {
  ...
  const configs = {
    ...
    rifle: {
      ...
      noiseVol: 0.06, noiseDur: 0.1, noiseHP: 600,
      gain: 0.04, tailFreq: 100, tailDecay: 0.1, tailGain: 0.015,
      distortion: 4,
    },
    shotgun: {
      freq: 70, freqEnd: 20, decay: 0.22,
      noiseVol: 0.07, noiseDur: 0.18, noiseHP: 300,
      gain: 0.05, tailFreq: 60, tailDecay: 0.15, tailGain: 0.02,
      distortion: 12,
    },
    heavy: {
      freq: 55, freqEnd: 18, decay: 0.25,
      noiseVol: 0.06, noiseDur: 0.15, noiseHP: 400,
      gain: 0.04, tailFreq: 50, tailDecay: 0.18, tailGain: 0.018,
      distortion: 10,
    },
    turret: {
      freq: 130, freqEnd: 45, decay: 0.08,
      noiseVol: 0.05, noiseDur: 0.06, noiseHP: 900,
      gain: 0.035, tailFreq: 90, tailDecay: 0.05, tailGain: 0.012,
      distortion: 5,
    },
    boss: {
      freq: 90, freqEnd: 22, decay: 0.28,
      noiseVol: 0.07, noiseDur: 0.18, noiseHP: 350,
      gain: 0.05, tailFreq: 55, tailDecay: 0.2, tailGain: 0.02,
      distortion: 14,
    },
  };
